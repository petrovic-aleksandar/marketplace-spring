...
insert into item_type (id, name, description, imagePath) values (1, 'Cars&Vehicles', 'Cars and other transportation. Scooters, bikes, trains, boats, yachts, airships..', 'Categories/1.jpg');
insert into item_type (id, name, description, imagePath) values (2, 'Home&Kitchen', 'Everything for your home, small home and kitchen electronics.', 'Categories/2.jpg');
insert into item_type (id, name, description, imagePath) values (3, 'Electronics', 'All kinds of devices. Gaming equipment, laptops, home appliances etc.', 'Categories/3.jpg');
insert into item_type (id, name, description, imagePath) values (4, 'Sports&Outdoors', 'Sports clothing and sport requisits.', 'Categories/4.jpg');
insert into item_type (id, name, description, imagePath) values (5, 'Womens clothing', 'Everything for women.', 'Categories/5.jpg');
insert into item_type (id, name, description, imagePath) values (6, 'Jewelry&Accesories', 'All kinds of jewelry and decorative items.', 'Categories/6.jpg');
insert into item_type (id, name, description, imagePath) values (7, 'Mens clothing', 'Clothing items for men', 'Categories/7.jpg');
insert into item_type (id, name, description, imagePath) values (8, 'Books&Media', 'Books and stuff.', 'Categories/8.jpg');
insert into item_type (id, name, description, imagePath) values (9, 'Services', 'For various intelectual or physical services.', 'Categories/9.jpg');
insert into item_type (id, name, description, imagePath) values (10, 'Other', 'Whatever else.', 'Categories/10.jpg');
